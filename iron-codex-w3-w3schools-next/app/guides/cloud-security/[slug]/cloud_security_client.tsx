...
// ---------- Nav + Search helpers --------------------------------------------
const hrefFor = (slug: Slug) => `/guides/cloud-security/${slug}`;
  ...
  useEffect(() => {
    if (process.env.NODE_ENV !== "production") {
      try {
        ...
        console.assert(hrefFor("intro") === "/guides/cloud-security/intro", "hrefFor(intro)");
        console.assert(hrefFor("oauth") === "/guides/cloud-security/oauth", "hrefFor(oauth)");
