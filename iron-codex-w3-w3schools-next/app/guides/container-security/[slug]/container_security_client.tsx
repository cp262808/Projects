...
const ContentBySlug: Record<string, any> = {
  "intro": dynamic(() => import("@/content/guides/container-security/intro.mdx")),
};

const TOC: TOCGroup[] = [
  ["Container Security", [{ id: "intro", label: "Introduction" }]],
];

export default function Client({ slug }: { slug: Slug }) {
  const Content = ContentBySlug[slug];
  return (
    <TopicShell kind="guides" topic="container-security" title="Container Security" slug={slug} toc={TOC}>
