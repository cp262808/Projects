...
const ContentBySlug: Record<string, any> = {
  "intro": dynamic(() => import("@/content/guides/incident-response/intro.mdx")),
};

const TOC: TOCGroup[] = [
  ["Incident Response", [{ id: "intro", label: "Introduction" }]],
];

export default function Client({ slug }: { slug: Slug }) {
  const Content = ContentBySlug[slug];
  return (
    <TopicShell kind="guides" topic="incident-response" title="Incident Response" slug={slug} toc={TOC}>
