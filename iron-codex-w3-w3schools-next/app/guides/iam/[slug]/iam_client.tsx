...
// ---------- Nav + Search helpers --------------------------------------------
const hrefFor = (slug: Slug) => `/guides/iam/${slug}`;
  ...
  useEffect(() => {
    if (process.env.NODE_ENV !== "production") {
      try {
        ...
        console.assert(hrefFor("intro") === "/guides/iam/intro", "hrefFor(intro)");
        console.assert(hrefFor("oauth") === "/guides/iam/oauth", "hrefFor(oauth)");
