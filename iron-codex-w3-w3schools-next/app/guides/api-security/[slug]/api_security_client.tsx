...
// ---------- Nav + Search helpers --------------------------------------------
const hrefFor = (slug: Slug) => `/guides/api-security/${slug}`;
  ...
  useEffect(() => {
    if (process.env.NODE_ENV !== "production") {
      try {
        ...
        console.assert(hrefFor("intro") === "/guides/api-security/intro", "hrefFor(intro)");
        console.assert(hrefFor("oauth") === "/guides/api-security/oauth", "hrefFor(oauth)");
