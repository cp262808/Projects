...
const ContentBySlug: Record<string, any> = {
  "intro": dynamic(() => import("@/content/topics/secrets-management/intro.mdx")),
};

const TOC: TOCGroup[] = [
  ["Secrets Management", [{ id: "intro", label: "Introduction" }]],
];

export default function Client({ slug }: { slug: Slug }) {
  const Content = ContentBySlug[slug];
  return (
    <TopicShell kind="topics" topic="secrets-management" title="Secrets Management" slug={slug} toc={TOC}>
