...
const ContentBySlug: Record<string, any> = {
  "intro": dynamic(() => import("@/content/topics/mobile-security/intro.mdx")),
};

const TOC: TOCGroup[] = [
  ["Mobile Security", [{ id: "intro", label: "Introduction" }]],
];

export default function Client({ slug }: { slug: Slug }) {
  const Content = ContentBySlug[slug];
  return (
    <TopicShell kind="topics" topic="mobile-security" title="Mobile Security" slug={slug} toc={TOC}>
