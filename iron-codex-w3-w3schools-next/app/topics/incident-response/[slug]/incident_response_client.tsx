...
// ---------- Nav + Search helpers --------------------------------------------
const hrefFor = (slug: Slug) => `/topics/incident-response/${slug}`;
  ...
  useEffect(() => {
    if (process.env.NODE_ENV !== "production") {
      try {
        ...
        console.assert(hrefFor("intro") === "/topics/incident-response/intro", "hrefFor(intro)");
        console.assert(hrefFor("oauth") === "/topics/incident-response/oauth", "hrefFor(oauth)");
