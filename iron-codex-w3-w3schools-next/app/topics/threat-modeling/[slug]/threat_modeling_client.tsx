...
const ContentBySlug: Record<string, any> = {
  "intro": dynamic(() => import("@/content/topics/threat-modeling/intro.mdx")),
};

const TOC: TOCGroup[] = [
  ["Threat Modeling", [{ id: "intro", label: "Introduction" }]],
];

export default function Client({ slug }: { slug: Slug }) {
  const Content = ContentBySlug[slug];
  return (
    <TopicShell kind="topics" topic="threat-modeling" title="Threat Modeling" slug={slug} toc={TOC}>
