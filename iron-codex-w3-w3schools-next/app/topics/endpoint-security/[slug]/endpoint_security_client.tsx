...
const ContentBySlug: Record<string, any> = {
  "intro": dynamic(() => import("@/content/topics/endpoint-security/intro.mdx")),
};

const TOC: TOCGroup[] = [
  ["Endpoint Security", [{ id: "intro", label: "Introduction" }]],
];

export default function Client({ slug }: { slug: Slug }) {
  const Content = ContentBySlug[slug];
  return (
    <TopicShell kind="topics" topic="endpoint-security" title="Endpoint Security" slug={slug} toc={TOC}>
