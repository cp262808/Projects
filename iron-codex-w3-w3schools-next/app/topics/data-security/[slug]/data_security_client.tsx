...
const ContentBySlug: Record<string, any> = {
  "intro": dynamic(() => import("@/content/topics/data-security/intro.mdx")),
};

const TOC: TOCGroup[] = [
  ["Data Security", [{ id: "intro", label: "Introduction" }]],
];

export default function Client({ slug }: { slug: Slug }) {
  const Content = ContentBySlug[slug];
  return (
    <TopicShell kind="topics" topic="data-security" title="Data Security" slug={slug} toc={TOC}>
