...
const ContentBySlug: Record<string, any> = {
  "intro": dynamic(() => import("@/content/topics/database-security/intro.mdx")),
};

const TOC: TOCGroup[] = [
  ["Database Security", [{ id: "intro", label: "Introduction" }]],
];

export default function Client({ slug }: { slug: Slug }) {
  const Content = ContentBySlug[slug];
  return (
    <TopicShell kind="topics" topic="database-security" title="Database Security" slug={slug} toc={TOC}>
