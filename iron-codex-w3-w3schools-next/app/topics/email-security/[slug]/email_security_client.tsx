...
const ContentBySlug: Record<string, any> = {
  "intro": dynamic(() => import("@/content/topics/email-security/intro.mdx")),
};

const TOC: TOCGroup[] = [
  ["Email Security", [{ id: "intro", label: "Introduction" }]],
];

export default function Client({ slug }: { slug: Slug }) {
  const Content = ContentBySlug[slug];
  return (
    <TopicShell kind="topics" topic="email-security" title="Email Security" slug={slug} toc={TOC}>
