...
const ContentBySlug: Record<string, any> = {
  "intro": dynamic(() => import("@/content/topics/physical-security/intro.mdx")),
};

const TOC: TOCGroup[] = [
  ["Physical Security", [{ id: "intro", label: "Introduction" }]],
];

export default function Client({ slug }: { slug: Slug }) {
  const Content = ContentBySlug[slug];
  return (
    <TopicShell kind="topics" topic="physical-security" title="Physical Security" slug={slug} toc={TOC}>
