      ...
      <div className="container">
        <div className="border rounded-xl overflow-hidden shadow-sm">
          ...
          <div className="bg-gray-50 relative p-4">
            <button id="copybtn" onClick={copy} className="absolute right-3 top-3 text-xs border px-3 py-1 rounded bg-white">Copy</button>
...
HTTP/1.1 401 Unauthorized
{
  ...
  "message": "JWT signature verification failed"
          ...
          <div className="bg-white border-t px-4 py-3 flex items-center justify-between flex-wrap gap-2">
